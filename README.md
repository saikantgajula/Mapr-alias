...
##### Example:-
```sh
[root@8vm1 ~]# source /home/mapr/alias/mapr_core.sh
[root@8vm1 ~]# wrestart
...
[mapr@8vm1 ~]$ maprbackup /opt/mapr/conf/mapr-clusters.conf
[mapr@8vm1 ~]$ ls -l /opt/mapr/conf/mapr-clusters.conf*
-rw-r--r-- 1 mapr mapr 51 Sep 25 16:35 /opt/mapr/conf/mapr-clusters.conf
...
[mapr@8vm1 ~]$ maprbackup /opt/mapr/conf/cldb.conf /opt/mapr/conf/clusterid
[mapr@8vm1 ~]$ ls -l /opt/mapr/conf/cldb.conf* /opt/mapr/conf/clusterid*
-rw-r--r-- 1 mapr mapr 2291 Sep 25 16:43 /opt/mapr/conf/cldb.conf
...
###### Example:-
```sh
[mapr@8vm1 app]$ source mapr_yarn.sh
...
## HBASE:-
```sh
$ source `pwd`/mapr_hbase.sh
```
###### Usage:-
```sh
source mapr_hbase.sh
```
